...
public class TestStSauceLabs {
	...
	public void setupbeforeTest() throws IOException, ATUTestRecorderException {
		...
		spark.config().setTheme(Theme.DARK); // Choix du th�me (DARK, STANDARD)
	...
	public void removeFromCartTest() throws IOException, ATUTestRecorderException {
		...
		try {
			// Assurez-vous que l'utilisateur est connect� avant de retirer un produit
	...
	public void filterProductsTest() throws IOException, ATUTestRecorderException {
		...
		try {
			...
			Assert.assertTrue(isSorted, "Les produits ne sont pas tri�s par prix!");
			test.pass("Filtre des produits appliqu� avec succ�s.");
		} catch (AssertionError e) {
			test.fail("�chec de l'application du filtre des produits: " + e.getMessage());
			throw e;
		}
	}
	...
	public void tearDown(ITestResult result) throws IOException, ATUTestRecorderException {
		...
		test.log(Status.INFO,
				"Vid�o ajout�e au rapport: <a href='" + VIDEO_LOCATION + "'>Cliquez ici pour voir la vid�o</a>");
